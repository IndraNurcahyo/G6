...
<!--<div class="login-page">
  <div class="form" >
    <div style="padding-top: 10px;"><img src="./asset/img/silele.png" class="rounded-circle" style="height:100px;" alt=""></div>
    <form class="register-form" method="POST" action="register1,php">
      ...
      <button type="submit" name="simpan" value="simpan">create</button>
...
<div class="login-page">
  <div class="form" >
    ...
    <form class="login-form" method="post" action="ceklogin.php">
      <h3 style="padding-top:10px;">Sign In</h3>
      <input type="text" placeholder="Username" name="username" required="required"/>
      <input type="password" placeholder="Password" name="password" required="required"/>
      <button type="submit" name ="login" value="login">login</button>
