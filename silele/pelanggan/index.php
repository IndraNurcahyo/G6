            ...
            <div class="col-md-9" id= "container">
                ...
                <section id ="movies-list">
                        <?php
										...
										<div class="col-md-3">        
											<div class="box">        
												<img src="../produk/<?php echo $data['foto_produk'];?>" width="200px" height="200px" />        
												<div class="desc">            
													<h3><?= $data['nama_produk']?></h3>            
													<p>Stok: <?= $data['stok']?> </p>        
												</div>        
											<div class="social">                       
												<div class="prize" >Rp <?= $data['harga']?></div>    
                                    				<a href="#edit_produk.php?id_produk=<?php echo $data['id_produk']; ?>"><button class="btn"><i type="button" class="fas fa-shopping-cart" style=" color: DarkSlateBlue; " ></i></button></a>
