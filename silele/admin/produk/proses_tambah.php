<?php
    ...
    if($foto_produk != ""){
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
            ...
            $query = "INSERT INTO produk (nama_produk, stok, harga, foto_produk) VALUES ('$nama', '$stok', '$harga', '$nama_gambar_baru')";
            ...
            $query = "INSERT INTO produk (nama_produk, stok, harga) VALUES ('$nama', '$stok', '$harga')";
            $result = mysqli_query($koneksi, $query);
